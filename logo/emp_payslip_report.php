...
<div class="col-lg-12">			
  ...
  <table width="100%" cellspacing="50" style="margin-top:-25px;">
  <tr>
    <td><span style="font-weight:bolder;"> Total Loan Amount :</span></td>
    <td><?php 
       include('conn.php'); 
	...
	<td>&nbsp;</td>
	<td>&nbsp;</td>
    <td ><span style="font-weight:bolder;"> Total Loan Paid :</span></td>
    <td><?php 	
        include('conn.php'); 
	...
	<td>&nbsp;</td>
	<td>&nbsp;</td>
	<td><span style="font-weight:bolder;"> Total Loan Balance  :</span></td>
    <td>
	<?php 
...
<div class="col-lg-12">			
  ...
  <table width="100%" cellspacing="50"  style="margin-top:-5px;">
  <tr> 
    <td>&nbsp;</td>
	<td>&nbsp;</td>
    <td>&nbsp;</td>
