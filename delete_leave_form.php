    ...
    <div class="row">
        ...
        <div class="panel panel-default">
		   <div class="panel-heading">
		    ...
		    <div class="page-heading"><i class="glyphicon glyphicon-trash"></i> Delete Leave </div>
		   </div>
...
<?php
       ...
       include ('conn.php');
       $get_id=$_GET['leave_form_id'];
	  
	  if(isset($_POST['yes'])){
        $delete ="delete from leave_form where leave_form_id='$get_id'";
