...
<html>
<head>
<title>Payroll System Management</title>
...
<div class="container" style="width:90%">
    ...
    <div class="row">
        ...
        <div class="panel panel-default">
		   <div class="panel-heading">
		     <button class="btn btn-default" id="display_span"><a href="#"><i class="glyphicon glyphicon-plus-sign" ></i><span >  Add New Award To Employee </span></a></button>
		   </div>
		   
		   <div class="panel-body">
		    <div id="show_pannel" style="display:none;" >
	        	...
	        	<label class="col-sm-1 control-label">: </label>
				    <div class="col-sm-8" style="weight:200px;" >					 
			...
			<div class="form-group">
	        	...
	        	<label class="col-sm-1 control-label">: </label>
                    ...
                    <div class="form-group">
	        	        <label for="award_title" class="col-sm-3 control-label">Award Title <span style="color:red;">* </span></label>
	        	        <label class="col-sm-1 control-label">: </label>
				    <div class="col-sm-8">
				        <input type="text" class="form-control" id="award_title" required value="<?php echo $award_title; ?>"  placeholder="Enter Award Title  " name="award_title" autocomplete="off">  
				    </div>
	                </div> <!-- /form-group-->  			
                    <div class="form-group">
	        	        <label for="gift_item" class="col-sm-3 control-label">Gift Item <span style="color:red;">* </span></label>
	        	        <label class="col-sm-1 control-label">: </label>
				    <div class="col-sm-8">
				        <input type="text" class="form-control" id="gift_item" required value="<?php echo $gift_item; ?>"  placeholder="Enter Gift Item " name="gift_item" autocomplete="off">  
				    </div>
	                </div> <!-- /form-group-->  					
                	<div class="form-group">
	        	        <label for="award_amount" class="col-sm-3 control-label">Award Amount <span style="color:red;">* </span></label>
	        	        <label class="col-sm-1 control-label">: </label>
				    <div class="col-sm-8">
				        <input type="number" class="form-control" id="award_amount" required value="<?php echo $award_amount; ?>"  placeholder="Enter Award Amount" name="award_amount" autocomplete="off">  
				    </div>
	                </div> <!-- /form-group-->   
                    <div class="form-group">
	        	       <label for="month" class="col-sm-3 control-label">Select Month <span style="color:red;">* </span></label>
	        	       <label class="col-sm-1 control-label">: </label>
				      <div class="col-sm-8">
				         <input type="text" class="form-control" required  id="month" value="<?php echo $month; ?>" placeholder="Select the month" name="month" autocomplete="off"  >
				       </div>
	                </div> <!-- /form-group-->               		
		            
				         <button type="submit" name="submit" class="form-control  btn btn-success" style="width:250px; margin-left:1205px;" >Save</button>	
	...
	<td> <?php echo " <a  title ='Award Report'  href='award_report?emp_id=$emp_id' class='label label-info'><i class='glyphicon glyphicon-print'> Print</i></a>" ?> | <?php echo "<a href='awards?award_id=$award_id' class='label label-primary'><i class='glyphicon glyphicon-edit'> Edit</i></a>" ?> | <?php echo "<a href='delete_award?award_id=$award_id' class='label label-danger'><i class='glyphicon glyphicon-trash'> Delete</i></a>" ?></td>
            </tr>
    <?php
	}
	?>
