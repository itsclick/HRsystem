...
<div class="container">
    ...
    <div class="row">
		...
		<div class="panel panel-default">
		   <div class="panel-heading">
		    ...
		    <div class="page-heading"><i class="glyphicon glyphicon-th-list"></i> View Loan </div>
		   </div>
	...
	<td> <?php echo " <a  title ='Loan Report'  href='loan_report?emp_id=$emp_id' class='label label-info'><i class='glyphicon glyphicon-print'> Print</i></a>" ?> </td>
            </tr>
    <?php
	}
	?>
