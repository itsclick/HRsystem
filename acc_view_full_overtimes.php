...
<div class="container" style="width:90%">
	...
	<td><?php echo "<a href='acc_edit_overtime?overtime_id=$overtime_id' class='label label-primary'><i class='glyphicon glyphicon-edit'> Edit</i></a>" ?> | <?php echo "<a href='acc_delete_overtime?overtime_id=$overtime_id' class='label label-danger'><i class='glyphicon glyphicon-trash'> Delete</i></a>" ?> </td>
            </tr>
    <?php
	}
	?>
