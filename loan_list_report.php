...
<div class="container_fluid">
 ...
 <div class="wrapper">
	...
	<h4 class="text-center"><span style='font-weight:bolder; margin-left:0px;'> List Of Employees Loan Report</span></h4>	</div> 
...
<table id="example" class="display nowrap" border=1;  style="width:100%; margin-left:10px;">
    ...
    <thead align="center" >
			   <tr>						
					...
					<th><span style='font-weight:bolder; margin-left:20px;'>Employee Name </span></th>
	...
	include('conn.php'); 
    $i = 0;	
	$result = mysqli_query($conn,"select * from loans l join employees e on l.emp_id = e.emp_id where loan_balance > 0  order by emp_fullname,loan_date ");
	...
	?>
	       <tr>
            <?php 
	include('conn.php'); 
	$result = mysqli_query($conn,"select sum(loan_balance) from loans ");
    while($row=mysqli_fetch_array($result)){
		$t_loan_balance =$row[0];	
		
        
	?>  
		   <td colspan="5" align="right" ><span style="margin-right:15px; font-weight:bolder;"> Total Loan</span> </td>
		   <td align="right"><?php echo "<span style='font-weight:bolder; margin-right:10px;'>".'GH¢'.' '. number_format($t_loan_balance,2,'.',',') . "</span>" ; ?></td>
		   </tr>
