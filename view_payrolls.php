...
<div class="container" style="width:90%">
		...
		<div class="panel panel-default">
		   ...
		   <div class="panel-body">
		    <div class="pull pull-right" style="padding-bottom:20px;">
			     ...
			     <button class="btn btn-default"><a href="view_full_payrolls"><i class="glyphicon glyphicon-plus-sign" ></i> View Full Payroll </a></button>
	...
	<td> <?php echo " <a  title ='Payslip'  href='emp_payslip_report?pay_id=$pay_id' class='label label-info'><i class='glyphicon glyphicon-print'> Payslip</i></a>" ?> | <?php echo "<a href='edit_payroll?pay_id=$pay_id' class='label label-primary'><i class='glyphicon glyphicon-edit'> Edit</i></a>" ?> | <?php echo "<a href='delete_payroll?pay_id=$pay_id' class='label label-danger'><i class='glyphicon glyphicon-trash'> Delete</i></a>" ?> </td>
            </tr>
    <?php
	}
	?>
