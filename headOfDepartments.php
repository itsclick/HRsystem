...
<div class="container" style="width:90%">
    ...
    <div class="row">
        ...
        <div class="panel panel-default">
		   <div class="panel-heading">	       
		    <div class="page-heading"><a href="departments" > <i class="glyphicon glyphicon-plus"></i> Add Department </a> </div>
		   </div>
		   
		   <div class="panel-body">
               <form name="form1" class="form-horiziontal" role="form" method="post">		        
			    <div id="container">
				    <div class="form-group">
                       
                      <select class="form-control" id="dep_id" name="dep_id" style="width:400px;"  required >
	...
	<td> <?php echo "<a href='HeadOfDepartments?head_dep_id=$head_dep_id' class='label label-primary'><i class='glyphicon glyphicon-edit'> Edit</i></a>" ?> | <?php echo "<a href='delete_HeadOfDepartments.php?head_dep_id=$head_dep_id' class='label label-danger'><i class='glyphicon glyphicon-trash'> Delete</i></a>" ?> </td>
            </tr>
    <?php
	}
	?>
