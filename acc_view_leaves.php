...
<div class="container" style="width:90%">
    ...
    <div class="row">
		...
		<div class="panel panel-default">
		    ...
		    <div class="panel-body" id="show_pannel" style="display:none;">
		      <div class="col-lg-12" >
                <form name="form1" class="form-inline" role="form" method="post" action="leaves_reports">
		          <div id="container" >		       
		...
		<div class="panel panel-default">
		   <div class="panel-heading">
		    ...
		    <div class="page-heading"><i class="glyphicon glyphicon-th-list"></i> View Leave </div>
		   </div>
	...
	$result = mysqli_query($conn,"select l.leave_form_id,l.emp_id,e.emp_fullname,l.head_dep_id,h.HeadOfDepartment,d.dep_name,l.start_date,l.end_date,l.total_days,
		...
		where year(l.start_date) = year(now())
		order by l.leave_form_id
						");
	...
	<td> <?php echo " <a  title ='Print'  href='emp_leaves_report?emp_id=$emp_id' class='label label-info'><i class='glyphicon glyphicon-print'> Print</i></a>" ?> </td>
            </tr>
    <?php
	}
	?>
