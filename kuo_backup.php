    ...
    <div class="row">
        ...
        <div class="panel panel-default">
		   <div class="panel-heading">		    
		    <div class="page-heading"><i class="glyphicon glyphicon-oil"></i> Backup Database </div>
		   </div>
		   ...
		   <div class="panel-body">
			...
			<div class="checkbox">
			 <label><input type="checkbox" id="check_all" />Select All</label> <hr>
			</div>
             <?php
            ...
            <input type="submit" name="submit" id="submit" class="btn btn-success" value="Backup" />
            </div>
            </form>
            </div> 
