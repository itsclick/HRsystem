...
// for holding any kind of document to unload
                   ...
                   if(move_uploaded_file($emp_photo_tmp,'./images/photo/'.$emp_photo))
			        {				
                       //inserting data
				      include ('conn.php');
				     ...
				     emp_contact_relationshipToEmp='$emp_contact_relationshipToEmp',position_id='$position_id',head_dep_id='$head_dep_id',basic_salary='$basic_salary' ,employment_type='$employment_type' ,emp_photo='$emp_photo',status='$status',annual_leave='$annual_leave',sick_leave='$sick_leave',year='$year' where emp_id=$emp_id ";
				    ...
				    } else if (move_uploaded_file($emp_resume_tmp,'./images/photo/'.$emp_resume))
                    {
                                //inserting data
				      include ('conn.php');
				     ...
				     emp_present_address='$emp_present_address',emp_city='$emp_city',emp_country='$emp_country',emp_mobile='$emp_mobile',emp_email='$emp_email',bank_name='$bank_name',bank_branch='$bank_branch',bank_account_name='$bank_account_name',
				     bank_account_no='$bank_account_no',emp_contact_fullname='$emp_contact_fullname',emp_contact_housenumber='$emp_contact_housenumber',emp_contact_mobile='$emp_contact_mobile',emp_contact_occupation='$emp_contact_occupation',
				     emp_contact_relationshipToEmp='$emp_contact_relationshipToEmp',position_id='$position_id',head_dep_id='$head_dep_id',basic_salary='$basic_salary' ,employment_type='$employment_type' , emp_resume='$emp_resume',status='$status',annual_leave='$annual_leave',sick_leave='$sick_leave',year='$year' where emp_id=$emp_id ";
				    ...
				    } else if(move_uploaded_file($emp_offerLetter_tmp,'./images/photo/'.$emp_offerLetter))
					{
						          //inserting data
				      include ('conn.php');
				     ...
				     emp_present_address='$emp_present_address',emp_city='$emp_city',emp_country='$emp_country',emp_mobile='$emp_mobile',emp_email='$emp_email',bank_name='$bank_name',bank_branch='$bank_branch',bank_account_name='$bank_account_name',
				     bank_account_no='$bank_account_no',emp_contact_fullname='$emp_contact_fullname',emp_contact_housenumber='$emp_contact_housenumber',emp_contact_mobile='$emp_contact_mobile',emp_contact_occupation='$emp_contact_occupation',
				     emp_contact_relationshipToEmp='$emp_contact_relationshipToEmp',position_id='$position_id',head_dep_id='$head_dep_id', basic_salary='$basic_salary' ,employment_type='$employment_type' ,emp_offerLetter='$emp_offerLetter',status='$status',annual_leave='$annual_leave',sick_leave='$sick_leave',year='$year' where emp_id=$emp_id ";
					...
					} else if(move_uploaded_file($emp_joiningLetter_tmp,'./images/photo/'.$emp_joiningLetter))
					{
						             //inserting data
				      include ('conn.php');
				     ...
				     emp_present_address='$emp_present_address',emp_city='$emp_city',emp_country='$emp_country',emp_mobile='$emp_mobile',emp_email='$emp_email',bank_name='$bank_name',bank_branch='$bank_branch',bank_account_name='$bank_account_name',
				     bank_account_no='$bank_account_no',emp_contact_fullname='$emp_contact_fullname',emp_contact_housenumber='$emp_contact_housenumber',emp_contact_mobile='$emp_contact_mobile',emp_contact_occupation='$emp_contact_occupation',
				     emp_contact_relationshipToEmp='$emp_contact_relationshipToEmp',position_id='$position_id',head_dep_id='$head_dep_id', basic_salary='$basic_salary' ,employment_type='$employment_type' ,emp_joiningLetter='$emp_joiningLetter',status='$status' ,annual_leave='$annual_leave',sick_leave='$sick_leave',year='$year' where emp_id=$emp_id ";
					...
					} else if (move_uploaded_file($emp_contractPaper_tmp,'./images/photo/'.$emp_contractPaper))
					{
						            //inserting data
				      include ('conn.php');
				     ...
				     emp_present_address='$emp_present_address',emp_city='$emp_city',emp_country='$emp_country',emp_mobile='$emp_mobile',emp_email='$emp_email',bank_name='$bank_name',bank_branch='$bank_branch',bank_account_name='$bank_account_name',
				     bank_account_no='$bank_account_no',emp_contact_fullname='$emp_contact_fullname',emp_contact_housenumber='$emp_contact_housenumber',emp_contact_mobile='$emp_contact_mobile',emp_contact_occupation='$emp_contact_occupation',
				     emp_contact_relationshipToEmp='$emp_contact_relationshipToEmp',position_id='$position_id',head_dep_id='$head_dep_id', basic_salary='$basic_salary' ,employment_type='$employment_type' ,emp_contractPaper='$emp_contractPaper',status='$status' ,annual_leave='$annual_leave',sick_leave='$sick_leave',year='$year' where emp_id=$emp_id ";
					...
					} else if (move_uploaded_file($emp_idProff_tmp,'./images/photo/'.$emp_idProff))
					{
						         //inserting data
				      include ('conn.php');
				     ...
				     emp_present_address='$emp_present_address',emp_city='$emp_city',emp_country='$emp_country',emp_mobile='$emp_mobile',emp_email='$emp_email',bank_name='$bank_name',bank_branch='$bank_branch',bank_account_name='$bank_account_name',
				     bank_account_no='$bank_account_no',emp_contact_fullname='$emp_contact_fullname',emp_contact_housenumber='$emp_contact_housenumber',emp_contact_mobile='$emp_contact_mobile',emp_contact_occupation='$emp_contact_occupation',
				     emp_contact_relationshipToEmp='$emp_contact_relationshipToEmp',position_id='$position_id',head_dep_id='$head_dep_id', basic_salary='$basic_salary' ,employment_type='$employment_type' ,emp_idProff='$emp_idProff',status='$status' ,annual_leave='$annual_leave',sick_leave='$sick_leave',year='$year' where emp_id=$emp_id ";
					...
					} else if (move_uploaded_file($emp_otherDocument_tmp,'./images/photo/'.$emp_otherDocument))
				    {
				     ...
				     emp_present_address='$emp_present_address',emp_city='$emp_city',emp_country='$emp_country',emp_mobile='$emp_mobile',emp_email='$emp_email',bank_name='$bank_name',bank_branch='$bank_branch',bank_account_name='$bank_account_name',
				     bank_account_no='$bank_account_no',emp_contact_fullname='$emp_contact_fullname',emp_contact_housenumber='$emp_contact_housenumber',emp_contact_mobile='$emp_contact_mobile',emp_contact_occupation='$emp_contact_occupation',
				     emp_contact_relationshipToEmp='$emp_contact_relationshipToEmp',position_id='$position_id',head_dep_id='$head_dep_id', basic_salary='$basic_salary' ,employment_type='$employment_type' ,emp_otherDocument='$emp_otherDocument',status='$status' ,annual_leave='$annual_leave',sick_leave='$sick_leave',year='$year' where emp_id=$emp_id ";
					...
					} else 
					{
				        ...
				        emp_present_address='$emp_present_address',emp_city='$emp_city',emp_country='$emp_country',emp_mobile='$emp_mobile',emp_email='$emp_email',bank_name='$bank_name',bank_branch='$bank_branch',bank_account_name='$bank_account_name',
				        bank_account_no='$bank_account_no',emp_contact_fullname='$emp_contact_fullname',emp_contact_housenumber='$emp_contact_housenumber',emp_contact_mobile='$emp_contact_mobile',emp_contact_occupation='$emp_contact_occupation',
				        emp_contact_relationshipToEmp='$emp_contact_relationshipToEmp',position_id='$position_id',head_dep_id='$head_dep_id', basic_salary='$basic_salary' ,employment_type='$employment_type' ,status='$status' ,annual_leave='$annual_leave',sick_leave='$sick_leave',year='$year' where emp_id=$emp_id ";
...
?>				 
		...
		<div id="container" >
            <div class="form-group">
                        ...
                        <div class="col-lg-8">
                            <div class="fileupload fileupload-new" data-provides="fileupload">
                                <div class="fileupload-new thumbnail" style="width: 200px; height: 150px;"><?php echo " <img src='./images/photo/$emp_photo' width='200' height='150' /> " ; ?></div>
                                <div class="fileupload-preview fileupload-exists thumbnail" style="max-width: 200px; max-height: 150px; line-height: 20px;"></div>
                                <div>
                                    <span class="btn btn-file btn-primary"><span class="fileupload-new">Select image</span><span class="fileupload-exists">Change</span><input type="file" id="emp_photo" name="emp_photo" /></span>
			...
			<div class="form-group">
	        	<label for="emp_code" class="col-sm-3 control-label">Employee ID :</label>
	        	<label class="col-sm-1 control-label">: </label>
				    <div class="col-sm-8">
				      <input type="text" class="form-control"  value="<?php echo $emp_code ; ?>" id="emp_code" placeholder="Employee ID" name="emp_code" autocomplete="off" >
				    </div>
	        </div> <!-- /form-group-->	
			<div class="form-group">
	        	<label for="emp_joining_date" class="col-sm-3 control-label">Employment Date :</label>
	        	<label class="col-sm-1 control-label">: </label>
				    <div class="col-sm-8">
				      <input type="date" class="form-control" value="<?php echo $emp_joining_date ; ?>"  id="emp_date-" placeholder="Date Of Employment" name="emp_joining_date" autocomplete="off"  >
				    </div>
	        </div> <!-- /form-group-->
			<div class="form-group">
	        	<label for="emp_fullname" class="col-sm-3 control-label">Employee Name :</label>
	        	<label class="col-sm-1 control-label">: </label>
				    <div class="col-sm-8">
				      <input type="text" class="form-control" value="<?php echo $emp_fullname ; ?>" id="emp_fullname" placeholder="Employee Full Name" name="emp_fullname" autocomplete="off"  >
				    </div>
	        </div> <!-- /form-group-->	
			<div class="form-group">
	        	...
	        	<label class="col-sm-1 control-label">: </label>
				    <div class="col-sm-8">
				      <input type="date" class="form-control" value="<?php echo $emp_dob ; ?>"  id="emp_dob-" placeholder="Employee Date of Birth" name="emp_dob" autocomplete="off"  >
				    </div>
	        </div> <!-- /form-group-->
			<div class="form-group">
  ...
  <option value="Zimbabwean">Zimbabwean</option> 
	...
	<option value="Zimbabwe">Zimbabwe</option>
	        	...
	        	<label class="col-sm-1 control-label">: </label>
				    <div class="col-sm-5">
				      <select class="form-control" id="position_id" name="position_id" >
					    <option value="<?php echo $position_id ; ?>"><?php echo $pos_name ; ?></option>
				      	<?php
                         include ('conn.php');
			...
			<div class="form-group">
	        	<label for="head_dep_id" class="col-sm-3 control-label">Head Of Department :</label>
	        	<label class="col-sm-1 control-label">: </label>
				    <div class="col-sm-5">
				      <select class="form-control" id="head_dep_id" name="head_dep_id" required>
					    <option value="<?php echo $head_dep_id ; ?>"><?php echo $dep_name." , ". $HeadOfDepartment  ; ?></option>
                        <?php
                        include ('conn.php');
			...
			<div class="form-group">
	        	...
	        	<label class="col-sm-1 control-label">: </label>
				    <div class="col-sm-8">
				      <input type="text" class="form-control" required id="basic_salary" value="<?php echo $row['basic_salary']  ; ?>" placeholder="Employee Basic Salary  " name="basic_salary" autocomplete="off"  >
				    </div>
	        </div> <!-- /form-group-->
			<div class="form-group">
            ...
            <div class="form-group">
	        	...
	        	<label class="col-sm-1 control-label">: </label>
				    <div class="col-sm-8">
				      <input type="text" class="form-control" required id="annual_leave" value="<?php echo $row['annual_leave']  ; ?>" placeholder="Employee Annual Leave   " name="annual_leave" autocomplete="off"  >
				    </div>
	        </div> <!-- /form-group-->	
            <div class="form-group">
	        	...
	        	<label class="col-sm-1 control-label">: </label>
				    <div class="col-sm-8">
				      <input type="text" class="form-control" required id="sick_leave" value="<?php echo $row['sick_leave']  ; ?>" placeholder="Employee Sick Leave   " name="sick_leave" autocomplete="off"  >
				    </div>
	        </div> <!-- /form-group-->
            <div class="form-group">
	        	...
	        	<label class="col-sm-1 control-label">: </label>
				    <div class="col-sm-8">
					   ...
					   <option value="<?php echo $row['year']  ; ?>"><?php echo $year ; ?></option>
				      	<?php
						    for ($i=2018 ; $i <= 3000 ; $i++ )
	                          {	
	        	...
	        	<label class="col-sm-1 control-label">: </label>
				    <div class="col-sm-4">
					    ...
					    <div class="kv-avatar center-block">					        
					        <input type="file" class="form-control" id="emp_resume" value = "" placeholder="Employee Resume Letter " name="emp_resume" class="file-loading" style="width:auto;"/>
					    </div>				      
				    </div>
					<div class="col-sm-4">
										
                     <form method="POST">                    
				     <a href="images/photo/<?php echo $emp_resume ; ?>" target="_blank" ><?php echo $emp_resume ; ?></a>					 
					 <!-- <input type="submit" name="delete_emp_resume" class=" btn btn-danger" style="margin-left:150px; width:100px; height:20px; line-height:6px;" value="Remove" /> -->
				    </form>
					</div>
        </div> <!-- /form-group-->	
			<div class="form-group">
	        	...
	        	<label class="col-sm-1 control-label">: </label>
				    <div class="col-sm-4">
					    <!-- the avatar markup -->
							<div id="kv-avatar-errors-1" class="center-block" style="display:none;"></div>							
					    <div class="kv-avatar center-block">					        
					        <input type="file" class="form-control" value="<?php echo $emp_offerLetter; ?>" id="emp_offerLetter" placeholder="Employee Offer Letter" name="emp_offerLetter" class="file-loading" style="width:auto;"/>
					    </div>				      
				    </div>
					<div class="col-sm-4">
				     <?php echo $emp_offerLetter; ?>
				    </div>
	        </div> <!-- /form-group-->	
			<div class="form-group">
	        	...
	        	<label class="col-sm-1 control-label">: </label>
				    <div class="col-sm-4">
					    <!-- the avatar markup -->
							<div id="kv-avatar-errors-1" class="center-block" style="display:none;"></div>							
					    <div class="kv-avatar center-block">					        
					        <input type="file" class="form-control" id="emp_joiningLetter" value="<?php echo $emp_joiningLetter; ?>" placeholder="Employee Joining Letter" name="emp_joiningLetter" class="file-loading" style="width:auto;"/>
					    </div>			      
				    </div>
					<div class="col-sm-4">
				     <?php echo $emp_joiningLetter; ?>
				    </div>
	        </div> <!-- /form-group-->	
			<div class="form-group">
	        	...
	        	<label class="col-sm-1 control-label">: </label>
				    <div class="col-sm-4">
					    <!-- the avatar markup -->
							<div id="kv-avatar-errors-1" class="center-block" style="display:none;"></div>							
					    <div class="kv-avatar center-block">					        
					        <input type="file" class="form-control" id="emp_contractPaper" value="<?php echo $emp_contractPaper; ?>" placeholder="Employee Contract Paper" name="emp_contractPaper" class="file-loading" style="width:auto;"/>
					    </div>				      
				    </div>
					<div class="col-sm-4">
				     <?php echo $emp_contractPaper; ?>
				    </div>
	        </div> <!-- /form-group-->	
			<div class="form-group">
	        	...
	        	<label class="col-sm-1 control-label">: </label>
				    <div class="col-sm-4">
					    <!-- the avatar markup -->
							<div id="kv-avatar-errors-1" class="center-block" style="display:none;"></div>							
					    <div class="kv-avatar center-block">					        
					        <input type="file" class="form-control" id="emp_idProff" value="<?php echo $emp_idProff; ?>"  placeholder="Employee ID Card" name="emp_idProff" class="file-loading" style="width:auto;"/>
					    </div>	      
				    </div>
					<div class="col-sm-4">
				     <?php echo $emp_idProff; ?>
				    </div>
	        </div> <!-- /form-group-->	
			<div class="form-group">
	        	...
	        	<label class="col-sm-1 control-label">: </label>
				    <div class="col-sm-4">
					    <!-- the avatar markup -->
							<div id="kv-avatar-errors-1" class="center-block" style="display:none;"></div>							
					    <div class="kv-avatar center-block">					        
					        <input type="file" class="form-control" id="emp_otherDocument" value="<?php echo $emp_otherDocument; ?>"  placeholder="Employee Other Document" name="emp_otherDocument" class="file-loading" style="width:auto;"/>
					    </div>
				      
				    </div>
					<div class="col-sm-4">
				     <?php echo $emp_otherDocument; ?>
				    </div>
	        </div> <!-- /form-group-->	
