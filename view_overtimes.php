...
<div class="container" style="width:90%">
		...
		<div class="panel panel-default">
		   ...
		   <div class="panel-body">
		    <div class="pull pull-right" style="padding-bottom:20px;">
			     ...
			     <button class="btn btn-default"><a href="view_full_overtimes"><i class="glyphicon glyphicon-th-list " ></i> View Full Overtime </a></button>
	...
	<td> <?php echo " <a  title ='Overtime list'  href='emp_overtimes_report?emp_id=$emp_id' class='label label-info'><i class='glyphicon glyphicon-print'> Print</i></a>" ?> | <?php echo "<a href='edit_overtime?overtime_id=$overtime_id' class='label label-primary'><i class='glyphicon glyphicon-edit'> Edit</i></a>" ?> | <?php echo "<a href='delete_overtime?overtime_id=$overtime_id' class='label label-danger'><i class='glyphicon glyphicon-trash'> Delete</i></a>" ?> </td>
            </tr>
    <?php
	}
	?>
