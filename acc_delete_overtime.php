    ...
    <div class="row">
        ...
        <div class="panel panel-default">
		   <div class="panel-heading">
		    ...
		    <div class="page-heading"><i class="glyphicon glyphicon-trash"></i> Delete Overtime </div>
		   </div>
...
<?php
       ...
       include ('conn.php');
       $get_id=$_GET['overtime_id'];
	  
	  if(isset($_POST['yes'])){
        $delete ="delete from overtimes where overtime_id='$get_id'";
        $run_customer = mysqli_query($conn, $delete);
	  
	  echo "<script>alert('Sorry, one record has been deleted!')</script>";
      echo "<script>window.open('acc_view_overtimes','_self')</script>";
