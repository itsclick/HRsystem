...
<div class="container_fluid">
 ...
 <div class="wrapper">
    ...
    <h4 class="text-center"><span style='font-weight:bolder; margin-left:0px;'><?php echo $emp_fullname; ?> Overtimes Report</span></h4>	</div> 
...
<div class="col-lg-12">			
  ...
  <tr>
    <td align=""><span style="font-weight:bolder;"> WorkingDays Hrs :</span></td>
    <td><?php 
    include('conn.php');
	$emp_id=$_GET['emp_id']; 
    $count_days ="select sum(number_of_hrs_mns) from overtimes 
	       where emp_id = $emp_id and overtime_time = 'Hours' and year(overtime_date) = year(now()) ";
	...
	<td>&nbsp;</td>
	<td>&nbsp;</td>
    <td align=""><span style="font-weight:bolder;"> Holiday/WeekEnd Hrs :</span></td>
    <td><?php 
	// total_days
	include('conn.php');
	$emp_id=$_GET['emp_id']; 
	...
	<td>&nbsp;</td>
	<td>&nbsp;</td>
	<td align=""><span style="font-weight:bolder;"> Total Hrs :</span></td>
    <td><?php 
  ...
  <table width="100%" cellspacing="50" style="margin-top:-35px;">
  <tr>
    <td align=""><span style="font-weight:bolder;"> WorkingDays Mms :</span></td>
    <td><?php 
    include('conn.php');
	$emp_id=$_GET['emp_id']; 
    $count_days ="select sum(number_of_hrs_mns) from overtimes 
	       where emp_id = $emp_id and overtime_time = 'Minutes' and year(overtime_date) = year(now()) ";
    $run_count_days = mysqli_query($conn, $count_days);
    while ($row = mysqli_fetch_array($run_count_days)){
    $number_of_hrs_mns =$row[0];	
	     if($number_of_hrs_mns != 0)
	...
	<td>&nbsp;</td>
	<td>&nbsp;</td>
    <td align=""><span style="font-weight:bolder;"> Holiday/WeekEnd Mms :</span></td>
    <td><?php 
	// total_days
	include('conn.php');
	$emp_id=$_GET['emp_id']; 
	...
	<td>&nbsp;</td>
	<td>&nbsp;</td>
	<td align=""><span style="font-weight:bolder;"> Total Mms :</span></td>
    <td><?php 
	$total_hrs =  $number_of_hrs_mns + $number_of_hrs_mns_hol  ;
	echo $total_hrs ; ?></td>
	<td>&nbsp;</td>
...
<?php
  ...
  ?>			
<table id="example" class="display nowrap" border=1;  style="width:100%; margin:-10px auto;">
    
    <thead>
			   <tr style="padding:0px;">						
					<th align="center">SN</th>
					<th align="center">Date  </th>
					<th align="left"><span style=' margin:5px auto;'>Duty & Place </span></th>			
					<th align="center">Time  </th>
					<th align="center">Type Of Overtime</th>
					...
					<th align="center">Overtime Paid  </th>					
	...
	$result = mysqli_query($conn,"select o.overtime_date,o.emp_id,e.emp_fullname,o.overtime_location,o.basic_salary,o.overtime_time,
						...
						where o.emp_id = $emp_id and year(o.overtime_date) = year(now())");
    while($row=mysqli_fetch_array($result))
	{
		$overtime_date =$row[0];
		$emp_id =$row['emp_id'];
	...
	?>      
            ...
            <tr>   
				...
				<td align="center"><?php echo $overtime_type ; ?></td>					
	...
	include('conn.php'); 
	$emp_id = $_GET['emp_id'];
	$result = mysqli_query($conn,"select sum(overtime_paid) from overtimes	where emp_id =$emp_id and year(overtime_date) = year(now()) ");
    while($row=mysqli_fetch_array($result)){
