...
<div class="container">
    ...
    <div class="row">
	    ...
	    <ol class="breadcrumb">
		  ...
		  <li class="Active">Head Of Department </li>
		
		</ol>
        <div class="panel panel-default">
		   <div class="panel-heading">
		    
		    <div class="page-heading"><i class="glyphicon glyphicon-trash"></i> Delete Head Of Department </div>
		   </div>
...
<?php
	  ...
	  if(isset($_POST['yes'])){
        $delete ="delete from headOfDepartments where head_dep_id='$get_id'";
