...
<table id="example" class="display nowrap" border=1;  style="width:100%; margin-top:-20px;">
        <caption><h4 class="text-center"><span style='font-weight:bolder; margin-left:0px;'> List Of Designations</span></h4></caption>
    <thead >
			   <tr>						
					<th width="50"><span style='font-weight:bolder; margin-left:15px;'>SN </span></th>
					<th><span style='font-weight:bolder; margin-left:10px;'>Designation </span></th>		
			   </tr>
			   </thead>
	<tbody>
    <?php 
	...
	?>      
            ...
            <tr>   
                ...
                <td align=""><span style='margin-left:10px;'><?php echo $position ; ?></span></td>	 			
           </tr>
    <?php
