<?php
$connect = new PDO("mysql:host=localhost;dbname=kuo_payroll", "root", "");
 ...
 <body>
  ...
  <div class="container">
   <div class="row">
    ...
    ?>
     <div class="checkbox">
      <label><input type="checkbox" class="checkbox_table" name="table[]" value="<?php echo $table["Tables_in_kuo_payroll"]; ?>" /> <?php echo $table["Tables_in_kuo_payroll"]; ?></label>
     </div>
    <?php
    }
    ?>
