...
// Loan 
include('conn.php'); 
    $sum_loan_paid ="select sum(loan_paid) from payroll 
	       where emp_id = $emp_id ";
...
<div class="col-lg-12">			
  ...
  <table width="100%" cellspacing="50" style="margin-top:-25px;">
  <tr>
    <td><span style="font-weight:bolder;"> T.Loan Amount :</span></td>
    <td><?php 

       include('conn.php'); 
       $sum_loan_amount ="select sum(l.loan_amount) from loan_history l join payroll p on l.pay_id =  p.pay_id 
	       where l.emp_id = $emp_id and l.pay_id = $pay_id and l.loan_balance > 0 ";
    ...
    <td><?php 	
        include('conn.php'); 
    $sum_loan_paid ="select sum(l.loan_paid) from loan_history l join payroll p on l.pay_id =  p.pay_id 
	       where l.emp_id = $emp_id and l.pay_id = $pay_id and l.loan_balance > 0  ";
    $run_sum_loan_paid = mysqli_query($conn, $sum_loan_paid);
	...
	include('conn.php'); 
    $sum_loan_bal ="select sum(l.loan_balance) from loan_history l join payroll p on l.pay_id =  p.pay_id 
	       where l.emp_id = $emp_id and l.pay_id = $pay_id and l.loan_balance > 0  ";
...
<div class="col-lg-12">			
  ...
  <tr> 
	...
	<td>&nbsp;</td>
	<td>&nbsp;</td>
    <td><?php echo "<span style='font-weight:bolder;'>".number_format($total_earnings,2,'.',',')." </span>" ; ?></td>
	<td>&nbsp;</td>
	<td>&nbsp;</td>
	<td>&nbsp;</td>
	<td>&nbsp;</td>
	...
	<td>&nbsp;</td>
	<td>&nbsp;</td>
    <td><?php echo "<span style='font-weight:bolder;'>".number_format($total_deductions,2,'.',',')." </span>" ; ?></td>
	<td>&nbsp;</td>
	<td>&nbsp;</td>
  </tr>
  <tr>
  ...
  <tr>
	...
	<td>&nbsp;</td>
	<td>&nbsp;</td>
    <td align="right"><span style="font-weight:bolder;" > Net Salary GH¢ : </span></td>
	<td>&nbsp;</td>
	<td>&nbsp;</td>
    <td><?php echo "<span style='font-weight:bolder; background-color: #CCC;'>".number_format($net_salary,2,'.',',') ." </span>"   ; ?></td>
	<td>&nbsp;</td>
	<td>&nbsp;</td>
  </tr>
  <tr>
  ...
  <table width="100%" cellspacing="50"  style="margin-top:-15px;">
  <tr>
	<td>&nbsp;</td>
    <td>&nbsp;</td>
    <td>&nbsp;</td>
