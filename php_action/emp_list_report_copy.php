...
<div class="container_fluid">
 ...
 <div class="wrapper">
	...
	<h3 class="panel-title"><i><span style="font-weight:; float:right; margin-top:10px" id="date_times">Printed : <?php echo date("d M Y H:i:s") ; ?> </span></i></h3>
	           ...
	           <?php
                 echo " <div class='col-md-12'> <div class='col-md-3' >".'SN' .' '.' '.'Full Name '.' '.' '.'Gender' ."</div> <div class='col-md-6' >". 'Nationality' .' '.' '. 'SSNIT No' .' '.' '. 'Mobile' ." </div> <div class='col-md-3'>".' E-mail Address' .' '.' '. 'Cont. Person' .' '.' '. 'Cont. Per. Mobile' ." </div> </div> ";
				 ?>
...
?>	             <?php
				 ...
				 echo " <div class='col-md-3' >". $i .' '.' '.$emp_fullname.' '.' '. $emp_gender ."</div>  " ;
                 echo " <div class='col-md-6' >". $emp_nationality .' '.' '. $emp_ssnit_number .' '.' '. $emp_mobile ." </div>";			 
				 echo " <div class='col-md-3'>". $emp_email .' '.' '. $emp_contact_fullname .' '.' '. $emp_contact_mobile ." </div>";
                 echo " </div> ";
				 ?>
