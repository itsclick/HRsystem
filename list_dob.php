    ...
    <div class="row">
        ...
        <div class="panel panel-default">
		   <div class="panel-heading">
		    ...
		    <div class="page-heading"><i class="glyphicon glyphicon-menu-hamburger"></i> List Of Employees' Birthday </div>
		   </div>
		   ...
		   <div class="panel-body">
			...
			<?php
				include('conn.php'); 
				$i = 0 ;
				$query =  "SELECT * from employees where month(emp_dob) = month(now()) order by emp_dob DESC ";		
                $result = mysqli_query($conn,$query);
                    while($row = mysqli_fetch_array($result)){
                    $emp_photo = $row['emp_photo'];
					$emp_fullname = $row['emp_fullname'];
                    $emp_dob = $row['emp_dob'];  
					$date = date("d-M-Y",strtotime($emp_dob));
					$dob  = date("M-Y",strtotime($emp_dob));
					$today = date("M-Y");
					$age = date_diff(date_create($dob),date_create($today));
					$i++;
					
                 echo " <div class='col-md-12'> "; 
				 echo " <div class='col-md-3' style='margin-right:-280px;'> ".$i."  ". " <img src='images/photo/$emp_photo' class='pic' /> <img src='images/photo/$emp_photo' class='picbig' /> </div>  " ;
                 echo " <div class='col-md-6' > <span style='font-weight:bolder;'> NAME :</span> "." ". $row['emp_fullname']."<br/> <span style='font-weight:bolder;'>  DOB : </span> "." ". $date."<br/>". " <span style='font-weight:bolder;'> AGE : </span>" .$age->format('%y')." "." Years Old <br/><br/> </div>";			 
